...
$tienda=$_POST["tienda"];
  ...
  $query="INSERT INTO administrador(Nombre,Apellido_P,Apellido_M,Email,Telefono,Contrasena,Usuario,Per_MOD,ID_Tienda) VALUES ('$name','$app','$apm','$mail','$tel','$encrypted','$user','$mod',$tienda)";
